...
public class LikeController implements CommunityConstant {
    ...
    public String like(int entityType, int entityId, int entityUserId, int postId) {
        ...
        long likeCount = Long.parseLong(likeService.findEntityLikeCount(entityType, entityId).getBody());
        int likeStatus = Integer.parseInt(likeService.findEntityLikeStatus(user.getId(), entityType, entityId).getBody());
