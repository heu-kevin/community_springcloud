package com.swim.community.quartz;

import com.swim.community.entity.DiscussPost;
import com.swim.community.service.ElasticsearchService;
...
public class PostScoreRefreshJob implements Job, CommunityConstant {
    ...
    static {
        try {
            ...
            throw new RuntimeException("初始化swim纪元失败！", e);
        }
    }
    ...
    private void refresh(int postId) {
        DiscussPost post = discussPostService.findDiscussPostById(postId).getBody();
        ...
        long likeCount = Long.parseLong(likeService.findEntityLikeCount(ENTITY_TYPE_POST, postId).getBody());
